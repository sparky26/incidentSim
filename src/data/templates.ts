...
export const TEMPLATES: Template[] = [
    ...
    },
    {
        ...
        nodes: [
            ...
            { id: 'responder-1', type: 'Responder', position: { x: 500, y: 440 }, data: { label: 'Payments Responder', baseResponseTimeMean: 8, baseResponseTimeStdDev: 2, fatigueSensitivity: 0.2, skillTags: ['payments'] } as any },
            { id: 'action-1', type: 'Action', position: { x: 500, y: 560 }, data: { label: 'Failover Vendor', requiredSkill: 'payments', durationMean: 12, durationStdDev: 3, successProbability: 0.85, isRollback: false } as any },
        ],
        edges: [
    ...
    },
    {
        ...
        nodes: [
            ...
            { id: 'autoscaler', type: 'Action', position: { x: 460, y: 710 }, data: { label: 'Scale Up', requiredSkill: 'scaling', durationMean: 5, durationStdDev: 1.5, successProbability: 0.7, isRollback: false } as any },
        ],
        edges: [
    ...
    },
    {
        ...
        nodes: [
            ...
            { id: 'responder-1', type: 'Responder', position: { x: 1110, y: 380 }, data: { label: 'Platform Responder', baseResponseTimeMean: 6, baseResponseTimeStdDev: 1.5, fatigueSensitivity: 0.2, shiftLengthHours: 8 } as any },
            { id: 'action-1', type: 'Action', position: { x: 1110, y: 520 }, data: { label: 'Rollback Deploy', requiredSkill: 'platform', durationMean: 8, durationStdDev: 2, successProbability: 0.85, isRollback: true } as any },
        ],
        edges: [
    ...
    },
    {
        ...
        nodes: [
            ...
            { id: 'responder-1', type: 'Responder', position: { x: 1110, y: 520 }, data: { label: 'Ops Responder', baseResponseTimeMean: 10, baseResponseTimeStdDev: 2.5, fatigueSensitivity: 0.3, shiftLengthHours: 10 } as any },
            { id: 'action-1', type: 'Action', position: { x: 1110, y: 660 }, data: { label: 'Enable Rate Limits', requiredSkill: 'ops', durationMean: 12, durationStdDev: 3, successProbability: 0.75, isRollback: false } as any },
        ],
        edges: [
