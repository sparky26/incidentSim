...
const DEFAULT_CONFIGS: Record<BlockType, BlockConfig> = {
    ...
    'Responder': { label: 'Responder', baseResponseTimeMean: 10, fatigueSensitivity: 0.1, shiftLengthHours: 8 } as any,
    ...
    'Action': { label: 'Action', requiredSkill: '', durationMean: 15, successProbability: 0.9, isRollback: false } as any,
};
