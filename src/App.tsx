...
function App() {
  const { nodes, edges, simulationConfig, setResults, setSimulating, isSimulating, results, loadTemplate } = useScenarioStore();
  ...
  const handleRun = useCallback(async () => {
    ...
    const blocks: Block[] = nodes.map(n => ({
      ...
      type: n.type as any,
      position: n.position,
      config: n.data // Ensure data is mapped to config
    }));
  ...
  }, [nodes, edges, simulationConfig, setResults, setSimulating]);
